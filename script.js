...
document.addEventListener('DOMContentLoaded', () => {
    // 1. ROLAGEM SUAVE AO CLICAR NOS BOTÕES DO CABEÇALHO E HERO
        ...
        link.addEventListener('click', function (e) {
            ...
            if (href !== '#' && href.startsWith('#')) {
                ...
                if (alvo) {
                    ...
                    // Rola a tela suavemente até a seção desejada
                    alvo.scrollIntoView({
                        behavior: 'smooth',
                        block: 'start'
                    });
    ...
    // 2. INTERAÇÃO DO FORMULÁRIO DE SOLICITAÇÃO (HOME)
    ...
    if (formSolicitacao) {
        formSolicitacao.addEventListener('submit', (e) => {
            ...
            const dataPref = document.getElementById('input-data').value;

            // Simulação de salvamento local (conforme o diagrama de classes)
